...
UserData mapUserData(dynamic payload) {
  return UserData(
    subscriptionRemainingDays: payload["subscription_end_in"] != null
        ? payload["subscription_end_in"].toString()
        : "No active subscription.",
    shift: payload["shift"] != null ? payload["shift"].toString() : "",
    tag: payload["tags"] != null ? payload["tags"].toString() : "",
    subscriptionEndDate: payload["subscription_end_date"] != null
        ? payload["subscription_end_date"].toString()
        : "No active subscription.",
    subscriptionName: payload["subscription_name"] != null
        ? payload["subscription_name"].toString()
        : "No active subscription.",
    subscriptionNameArabic: payload["subscription_arabic_name"] != null
        ? payload["subscription_arabic_name"].toString()
        : "No active subscription.",
    id: payload["id"] ?? -1,
    ...
    email: payload["email"] != null
        ...
        : "",
    firstName: payload["first_name"] != null && payload["first_name"] != false
        ? payload["first_name"]
        : "",
    firstNameArabic: payload["first_name_arabic"] != null &&
            payload["first_name_arabic"] != false
        ? payload["first_name_arabic"]
        : "",
    lastName: payload["last_name"] != null && payload["last_name"] != false
        ? payload["last_name"]
        : "",
    lastNameArabic: payload["last_name_arabic"] != null &&
            payload["last_name_arabic"] != false
        ? payload["last_name_arabic"]
        : "",
    appBackground:
        payload["app_background"] != null && payload["app_background"] != false
            ? payload["app_background"]
            : "",
    gender: payload["gender"] != null ? payload["gender"].toString() : "",
    birthday: payload["date_of_birth"] != null
        ? payload["date_of_birth"].toString()
        : "",
    height: payload["height"] != null
        ? double.parse(payload["height"].toString())
        : 0.0,
    weight: payload["weight"] != null
        ? double.parse(payload["weight"].toString())
        : 0.0,
  );
}
