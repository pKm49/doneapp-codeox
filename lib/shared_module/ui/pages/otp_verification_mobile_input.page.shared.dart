...
class OtpVerificationMobileInputPage_Shared extends StatefulWidget {
  ...
  @override
  State<OtpVerificationMobileInputPage_Shared> createState() =>
      _OtpVerificationMobileInputPage_SharedState();
}

class _OtpVerificationMobileInputPage_SharedState
    extends State<OtpVerificationMobileInputPage_Shared> {
                ...
                child: ListView(
                  children: [
                    Row(
                      ...
                      children: [
                        Image.asset(ASSETS_MOBILEVERIFICATION,
                            width: screenwidth * .8),
                      ],
                    ),
                    ...
                    TextFormField(
                        controller:
                            sharedController.mobileTextEditingController.value,
