...
class PaymentGatewayWebView_Shared extends StatefulWidget {
  ...
  @override
  _PaymentGatewayWebView_SharedState createState() =>
      _PaymentGatewayWebView_SharedState();
}

class _PaymentGatewayWebView_SharedState
    extends State<PaymentGatewayWebView_Shared> {
    ...
    return WillPopScope(
      ...
      child: Obx(
        () => Scaffold(
            ...
            bottomSheet: (sharedController.paymentGatewayIsLoading.value ||
