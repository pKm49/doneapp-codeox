...
class OtpVerificationOtpInputPage_Shared extends StatefulWidget {
  ...
  @override
  State<OtpVerificationOtpInputPage_Shared> createState() =>
      _OtpVerificationOtpInputPage_SharedState();
}

class _OtpVerificationOtpInputPage_SharedState
    extends State<OtpVerificationOtpInputPage_Shared> {
  var getArguments = Get.arguments;
  final sharedController = Get.find<SharedController>();
  VALIDPHONEVERIFICATION_MODES phoneVerificationMode =
  ...
  void initState() {
    ...
    phoneVerificationMode =
        getArguments[0] ?? VALIDPHONEVERIFICATION_MODES.register;
  }
                  ...
                  children: [
                    ...
                    Text("verification_code".tr,
                        ...
                        style: getHeadlineLargeStyle(context)
                            .copyWith(fontSize: APPSTYLE_FontSize24 * 1.5)),
                    addVerticalSpace(APPSTYLE_SpaceLarge),
                    Text(
                        "enter_otp".tr.replaceAll("mobile",
                            "+965 ${sharedController.mobileTextEditingController.value.text}"),
                        textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {
                              sharedController.sendOtp(
                                  phoneVerificationMode ==
                                      VALIDPHONEVERIFICATION_MODES
                                          .reset_password,
                                  true);
                            },
                            child: Text(
              ...
              Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                        child: sharedController.isOtpVerifying.value ||
                                sharedController.isOtpSending.value
