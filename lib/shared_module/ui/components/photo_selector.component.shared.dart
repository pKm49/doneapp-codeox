  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      contentPadding: const EdgeInsets.symmetric(
          vertical: APPSTYLE_SpaceMedium, horizontal: APPSTYLE_SpaceMedium),
      content: SizedBox(
        height: Localizations.localeOf(context).languageCode.toString() == 'ar'
            ? 125
            : 100,
        child: Column(
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    const Icon(Icons.camera_alt, color: APPSTYLE_PrimaryColor),
                    addHorizontalSpace(APPSTYLE_SpaceMedium),
                    Expanded(
