...
class _RegisterOriginPage_AuthState extends State<RegisterOriginPage_Auth> {
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Radio(
                                ...
                                onChanged: (value) {
                                  if (value != null) {
                                    registerController.changeSource(
                                        VALID_SOURCES.social.name);
                                  }
                                },
                          ...
                          children: [
                            Radio(
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  registerController
                                      .changeSource(VALID_SOURCES.friends.name);
                                }
                              },
                              groupValue: registerController.source.value,
                            ),
                          ...
                          children: [
                            Radio(
                              ...
                              onChanged: (value) {
                                if (value != null) {
                                  registerController
                                      .changeSource(VALID_SOURCES.other.name);
                        ...
                        Visibility(
                          visible: registerController.source.value ==
                              VALID_SOURCES.other.name,
                          child: TextFormField(
                            focusNode: otherSourceTextFieldFocusNode,
                            controller: registerController
                                .otherSourceTextEditingController.value,
                            decoration: InputDecoration(
                                hintText: "let_us_know_how_you_found_us".tr),
                          ),
                        ),
                      ],
                    ),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (!registerController.isRegisterSubmitting.value) {
                            registerController.handleRegistration(
                                registerController.source.value);
                          }
                        },
                        style: getElevatedButtonStyle(context),
                        child: sharedController.isUserDataFetching.value ||
                                registerController.isRegisterSubmitting.value
