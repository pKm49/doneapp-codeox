...
class _RegisterAboutmePage_AuthState extends State<RegisterAboutmePage_Auth> {
                    ...
                    child: Form(
                      ...
                      child: ListView(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    registerController.changeGender(
                          ...
                          TextFormField(
                              controller:
                                  registerController.birthDayController.value,
                              onTap: () {
                                showDOBPickerDialog();
                              },
                              showCursor: true,
                              ...
                              Expanded(
                                ...
                                child: TextFormField(
                                  controller: registerController
                                      .heightTextEditingController.value,
                                  validator: (password) =>
                          ...
                          Row(
                            children: [
                              Expanded(
                                ...
                                child: TextFormField(
                                  controller: registerController
                                      .weightTextEditingController.value,
                                  validator: (password) =>
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (registerEnglishNameFormKey.currentState!
                                  .validate() &&
                              !isSameDay(registerController.selectedDOB.value,
                                  DateTime.now())) {
                            Get.toNamed(AppRouteNames.registerOriginRoute);
                          } else {
                            if (isSameDay(registerController.selectedDOB.value,
                                DateTime.now())) {
