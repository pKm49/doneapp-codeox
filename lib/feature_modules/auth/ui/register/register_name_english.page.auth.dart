...
class RegisterNameEnglishPage_Auth extends StatefulWidget {
  ...
  @override
  State<RegisterNameEnglishPage_Auth> createState() =>
      _RegisterNameEnglishPage_AuthState();
}

class _RegisterNameEnglishPage_AuthState
    extends State<RegisterNameEnglishPage_Auth> {
                      ...
                      child: ListView(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              UpdateProfilePic(
                                ...
                                profilePictureUrl:
                                    registerController.profilePictureUrl.value,
                              ),
                            ],
                          ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: registerController
                                  .firstNameEnglishTextEditingController.value,
                              validator: (email) =>
                                  checkIfNameFormValid(email, 'first_name_en'),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: registerController
                                  .lastNameEnglishTextEditingController.value,
                              validator: (email) =>
                                  checkIfNameFormValid(email, 'last_name_en'),
                              decoration: InputDecoration(
