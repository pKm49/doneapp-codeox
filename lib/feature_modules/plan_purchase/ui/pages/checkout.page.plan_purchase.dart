...
class _CheckoutPage_PlanPurchaseState extends State<CheckoutPage_PlanPurchase> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
          ...
          appBar: !planPurchaseController.isPaymentGatewayLoading.value
              ? AppBar(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Visibility(
                      visible:
                          planPurchaseController.isPaymentGatewayLoading.value,
                      child: Expanded(
                        child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                              controller: planPurchaseController
