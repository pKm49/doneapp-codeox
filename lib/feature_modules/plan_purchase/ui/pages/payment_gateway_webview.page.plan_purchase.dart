...
class PaymentGatewayWebView_PlanPurchase extends StatefulWidget {
  ...
  @override
  _PaymentGatewayWebView_PlanPurchaseState createState() =>
      _PaymentGatewayWebView_PlanPurchaseState();
}

class _PaymentGatewayWebView_PlanPurchaseState
    extends State<PaymentGatewayWebView_PlanPurchase> {
        ...
        () => Scaffold(
            ...
            body: InAppWebView(
              ...
              onUpdateVisitedHistory:
                  (InAppWebViewController controller, Uri? url, bool? flag) {
                if (url.toString().contains(
                    "https://erp.donekw.com/subscription/payment/status")) {
            ...
            bottomSheet:
                (subscriptionsController.paymentGatewayIsLoading.value ||
                        isConfirmationReached)
                    ? Container(
                        width: screenwidth,
                        height: screenheight,
