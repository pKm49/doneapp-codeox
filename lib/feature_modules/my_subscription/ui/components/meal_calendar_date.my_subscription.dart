...
class MealCalendarDateComponent_MySubscription extends StatelessWidget {
  ...
  MealCalendarDateComponent_MySubscription(
      {super.key,
                  ...
                  style: getLabelLargeStyle(context).copyWith(
                      color: isSelected
                          ...
                          : status == VALIDSUBSCRIPTIONDAY_STATUS.offDay &&
                                  (isSubscriptionDay && isMonthDay)
                              ? APPSTYLE_GuideRed
                              : status == VALIDSUBSCRIPTIONDAY_STATUS.freezed &&
                                      (isSubscriptionDay && isMonthDay)
