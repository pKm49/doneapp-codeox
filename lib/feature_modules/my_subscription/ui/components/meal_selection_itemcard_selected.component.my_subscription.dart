...
class MealSelectionItemCardSelectedComponent_MySubscription
    extends StatefulWidget {
  SubscriptoinDailyMealItem subscriptoinDailyMealItem;
  final Function(int count) onAdded; // <------------|
  int selectedCount;
  bool isSelectable;
  MealSelectionItemCardSelectedComponent_MySubscription(
      {super.key,
  ...
  @override
  State<MealSelectionItemCardSelectedComponent_MySubscription> createState() =>
      _MealSelectionItemCardSelectedComponent_MySubscriptionState();
}

class _MealSelectionItemCardSelectedComponent_MySubscriptionState
    extends State<MealSelectionItemCardSelectedComponent_MySubscription> {
  late Timer _timer;
                    ...
                    Column(
                      ...
                      children: [
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: widget.selectedCount == -1
