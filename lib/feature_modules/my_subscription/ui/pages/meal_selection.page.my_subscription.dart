...
import 'package:dietdone/feature_modules/my_subscription/ui/components/meal_calendar_date_mealselection.my_subscription.dart';
import 'package:dietdone/feature_modules/my_subscription/ui/components/meal_selection_frozenoffday_info.page.my_subscription.dart';
import 'package:dietdone/feature_modules/my_subscription/ui/components/meal_selection_itemcard_selected.component.my_subscription.dart';
import 'package:dietdone/feature_modules/my_subscription/ui/components/meal_selection_itemsloader.component.my_subscription.dart';
import 'package:dietdone/feature_modules/my_subscription/ui/components/meal_selection_titleloader.component.my_subscription.dart';
...
class _MealSelectionPage_MySubscriptionState
      ...
      onPopInvoked: (didPop) {
        if (didPop) {
          ...
          if (ifSaveOperationAllowed()) {
            int subscriptionId = mySubscriptionController
                .getDaySubId(mySubscriptionController.selectedDate.value);
            mySubscriptionController.setMealsByDate(
                false, subscriptionId, true);
              ...
              children: [
                CustomBackButton(
                    onDeleteSelected: () {
                      if (ifSaveOperationAllowed()) {
                        int subscriptionId =
                            mySubscriptionController.getDaySubId(
            ...
            actions: [
              Visibility(
                visible: !mySubscriptionController.isDayMealSaving.value &&
                    ...
                    !isTodayTomorrow(
                        mySubscriptionController.selectedDate.value) &&
                    mySubscriptionController.getDayStatus(
                            mySubscriptionController.selectedDate.value) !=
              ...
              children: [
                Padding(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        for (var date
                            in mySubscriptionController.subscriptionDates)
                          InkWell(
                              onTap: () {
                                mySubscriptionController.getMealsByDate(
                                    date.date, false);
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, indx) {
                              return MealSelectionItemCardSelectedComponent_MySubscription(
                                  isSelectable: true,
                                  selectedCount: mySubscriptionController
                ...
                Visibility(
                  visible: !mySubscriptionController.isMealsFetching.value &&
                      ...
                      mySubscriptionController
                          .subscriptoinMealConfig.value.meals.isNotEmpty &&
                      (mySubscriptionController.getDayStatus(mySubscriptionController
                                  .selectedDate.value) ==
                              VALIDSUBSCRIPTIONDAY_STATUS.delivered ||
                          ((mySubscriptionController.getDayStatus(
                                          mySubscriptionController
                ...
                Visibility(
                  visible: !mySubscriptionController.isMealsFetching.value &&
                      ...
                      mySubscriptionController.getDayStatus(
                          ...
                          VALIDSUBSCRIPTIONDAY_STATUS.offDay,
                  child: Expanded(
                      child: MealSelectionFrozenOffDayInfoPage_MySubscriptions(
                          isFrozen: false)),
                ),
                      ...
                      (mySubscriptionController.getDayStatus(
                          ...
                          (mySubscriptionController.getDayStatus(
                                      mySubscriptionController
                                          .selectedDate.value) ==
                                  VALIDSUBSCRIPTIONDAY_STATUS.freezed &&
                              !isTodayTomorrow(mySubscriptionController
                                  .selectedDate.value))),
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Visibility(
                          visible: (mySubscriptionController.getDayStatus(
                                          mySubscriptionController
                                              .selectedDate.value) ==
                                      VALIDSUBSCRIPTIONDAY_STATUS.freezed ||
                                  mySubscriptionController.getDayStatus(
  ...
  void showFreezeConfirmDialogue(BuildContext context) async {
    ...
    final dialogTextWidget = Text(
      mySubscriptionController
                  .getDayStatus(mySubscriptionController.selectedDate.value) !=
              VALIDSUBSCRIPTIONDAY_STATUS.freezed
  ...
  void openDislikeConfirm(int index, int categoryId, int itemId, int count,
      BuildContext context) async {
    final dialogTitleWidget = Text('confirm_selection'.tr,
        style: getHeadlineMediumStyle(context).copyWith(
            color: APPSTYLE_Grey80, fontWeight: APPSTYLE_FontWeightBold));
    final dialogTextWidget = Text(
      'confirm_selection_message'.tr,
      style: getBodyMediumStyle(context),
    );
  ...
  void openExtraCaloryConfirm(int index, int categoryId, int itemId, int count,
      BuildContext context) async {
    final dialogTitleWidget = Text('confirm_selection'.tr,
        style: getHeadlineMediumStyle(context).copyWith(
            color: APPSTYLE_Grey80, fontWeight: APPSTYLE_FontWeightBold));
    final dialogTextWidget = Text(
      'confirm_selection_message_calory'.tr,
      style: getBodyMediumStyle(context),
    );
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Visibility(
                          visible:
                              mySubscriptionController.isRatingSubmitting.value,
                          child: Expanded(
                            flex: 1,
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
  ...
  bool ifSaveOperationAllowed() {
    ...
    final subscriptionDates =
        mySubscriptionController.getDayStatus(selectedDate);
    final isDateBeforeTwoDays =
        selectedDate.isBefore(DateTime.now().add(const Duration(days: 2)));
    ...
    if (mySubscriptionController.isDayMealSaving.value ||
        ...
        (subscriptionDates == VALIDSUBSCRIPTIONDAY_STATUS.freezed &&
            isDateBeforeTwoDays) ||
        isDateBeforeTwoDays) {
      return false;
    }
