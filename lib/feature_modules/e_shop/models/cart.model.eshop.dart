...
OrderLine mapOrderLine(dynamic payload) {
  return OrderLine(
      ...
      imageUrl: payload["image"] != null
          ...
          : ASSETS_SAMPLEFOOD,
      mealName: payload["meal_name"] != null && payload["meal_name"] != false
          ? payload["meal_name"]
          : "",
      mealNameArabic: payload["meal_arabic_name"] != null &&
              payload["meal_arabic_name"] != false
          ? payload["meal_arabic_name"]
          : "",
      quantity: payload["quantity"] != null
          ? double.parse(payload["quantity"].toString()).round()
          : 0,
