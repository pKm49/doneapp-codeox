...
class CartPage_Eshop extends StatefulWidget {
  ...
  @override
  State<CartPage_Eshop> createState() => _CartPage_EshopState();
}

class _CartPage_EshopState extends State<CartPage_Eshop> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Visibility(
                      visible: !eshopController.isCartDetailsFetching.value &&
                          eshopController.cart.value.orderLine.isEmpty,
                      child: Expanded(
                        child: Container(
                          child: Expanded(
                              child: Column(
                        ...
                        children: [
                          ...
                          for (var i = 0;
                            ...
                            Container(
                                ...
                                margin:
                                    APPSTYLE_LargePaddingHorizontal.copyWith(
