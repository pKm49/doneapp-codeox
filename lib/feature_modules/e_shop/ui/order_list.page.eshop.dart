...
class OrderListPage_Eshop extends StatefulWidget {
  ...
  @override
  State<OrderListPage_Eshop> createState() => _OrderListPage_EshopState();
}

class _OrderListPage_EshopState extends State<OrderListPage_Eshop> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Visibility(
                      visible: !eshopController.isOrdersFetching.value &&
                          eshopController.orders.isEmpty,
                      child: Expanded(
                        child: Container(
                          child: Expanded(
                              child: Column(
                  ...
                  Visibility(
                    visible: !eshopController.isOrdersFetching.value &&
                        eshopController.orders.isNotEmpty,
                    child: Expanded(
                        child: Container(
                      child: ListView(
                        children: [
                          ...
                          for (var i = 0;
                              i < eshopController.orders.length;
                              i++)
                            Container(
                                decoration:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            '# ${eshopController.orders[i].orderReference}',
                                            maxLines: 2,
                                            textAlign: TextAlign.center,
                                          ...
                                          Container(
                                            ...
                                            padding:
                                                APPSTYLE_ExtraSmallPaddingVertical
                                                    .copyWith(
                                                        left:
                                                            APPSTYLE_SpaceSmall,
                                                        right:
                                                            APPSTYLE_SpaceSmall),
                                            child: Text(
                                                '${eshopController.orders[i].state}',
                                      ...
                                      Row(
                                        ...
                                        children: [
                                                ...
                                                APPSTYLE_ExtraSmallPaddingVertical
                                                    .copyWith(
                                                        ...
                                                        right:
                                                            APPSTYLE_SpaceSmall),
                                            child: Text(
                                                'Total : ${eshopController.orders[i].total} KD',
                                                style: getLabelLargeStyle(
                                                        context)
                                                    .copyWith(
                                                        color:
                                          ...
                                          Text(
                                            '${eshopController.orders[i].invoiceReference}',
                                            maxLines: 2,
                                            textAlign: TextAlign.center,
                                            style:
                                                getHeadlineMediumStyle(context)
                                                    .copyWith(
                                                        color: APPSTYLE_Grey80),
                                          ),
                                        ],
