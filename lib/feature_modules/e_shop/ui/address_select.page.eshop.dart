...
import 'package:doneapp/feature_modules/e_shop/ui/components/address_card.component.eshop.dart';
            ...
            child: Obx(
                ...
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible:   addressController.isCustomerAddressListFetching.value || addressController.isShiftFetching.value  ,
                      child: Expanded(
                          child: ListView(
                            children: [
                              Container(
                ...
                Visibility(
                    ...
                    Visibility(
                      visible: addressController.shiftList.isNotEmpty && !addressController.isShiftFetching.value,
                      child: Container(
                        ...
                        child: DropDownSelector(
                          ...
                          valueChanged: (newAreaId) {
                            addressController.changeShiftId(
                                int.parse(newAreaId));
                          },
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if(addressController.addressId.value !=-1 && addressController.shiftId.value !=-1){
