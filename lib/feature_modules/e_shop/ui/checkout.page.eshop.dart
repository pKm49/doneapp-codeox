...
class CheckoutPage_Eshop extends StatefulWidget {
  ...
  @override
  State<CheckoutPage_Eshop> createState() => _CheckoutPage_EshopState();
}

class _CheckoutPage_EshopState extends State<CheckoutPage_Eshop> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
          ...
          appBar: !eshopController.isPaymentGatewayLoading.value
              ? AppBar(
                    ...
                    child: Expanded(
                      ...
                      child: ListView(
                        children: [
                          ...
                          for (var i = 0;
                              i < eshopController.cart.value.orderLine.length;
                              i++)
                            Container(
                                decoration:
                                    ...
                                    Expanded(
                                      child: Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              '${Localizations.localeOf(context).languageCode.toString() == 'ar' ? eshopController.cart.value.orderLine[i].mealNameArabic : eshopController.cart.value.orderLine[i].mealName}',
                                              maxLines: 2,
                                              textAlign: TextAlign.start,
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                addHorizontalSpace(
                                                    APPSTYLE_SpaceSmall),
                                                Text(
                                                    eshopController.cart.value
                                                        .orderLine[i].quantity
                                                        .toString(),
                                                    style:
                                                        getHeadlineLargeStyle(
                                                            context)),
                                                addHorizontalSpace(
                                                    APPSTYLE_SpaceSmall),
                                                InkWell(
                                                ...
                                                Container(
                                                  ...
                                                  padding: APPSTYLE_ExtraSmallPaddingVertical
                                                      .copyWith(
                                                          left:
                                                              APPSTYLE_SpaceSmall,
                                                          right:
                                                              APPSTYLE_SpaceSmall),
                                                  child: Text(
                                                      '${eshopController.cart.value.orderLine[i].price} KD',
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                              controller: eshopController
                                                  .couponCodeController.value,
                                              decoration:
                                                  noBorderInputDecoration
                                                      .copyWith(
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: APPSTYLE_BorderedContainerDarkSmallDecoration
                                                .copyWith(
                                                    color: eshopController
                                                            .isCouponCodeValid
                                                            .value
                                                        ? APPSTYLE_WhatsappGreen
                                                        : APPSTYLE_PrimaryColor),
                                            child: eshopController
                                                    .isCouponChecking.value
