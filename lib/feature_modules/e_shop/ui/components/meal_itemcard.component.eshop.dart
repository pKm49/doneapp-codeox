...
class MealItemCardComponent_Eshop extends StatefulWidget {
  ...
  @override
  State<MealItemCardComponent_Eshop> createState() =>
      _MealItemCardComponent_EshopState();
}

class _MealItemCardComponent_EshopState
    extends State<MealItemCardComponent_Eshop> {
  late Timer _timer;
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
          decoration: APPSTYLE_BorderedContainerSmallDecoration.copyWith(
              ...
              border: Border.all(
                  color:
                      (widget.selectedCount > 0 || widget.selectedCount == -1)
                          ? APPSTYLE_GuideGreen
                          : APPSTYLE_Grey40,
                  width:
                      (widget.selectedCount > 0 || widget.selectedCount == -1)
                          ...
                          itemBuilder: (context, index) {
                            return Text(
                              Localizations.localeOf(context)
                                      ...
                                      'ar'
                                  ? widget
                                      .mealItem.ingredients[index].arabicName
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${Localizations.localeOf(context).languageCode.toString() == 'ar' ? widget.mealItem.arabicName : widget.mealItem.name} - ${widget.mealItem.rating}⭐ (${widget.mealItem.rating_count})',
                          maxLines: 2,
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              alignment: Alignment.centerRight,
                              fit: BoxFit.scaleDown,
                              child: Text('${widget.mealItem.fat} ${'fat'.tr}',
                                  style: getLabelLargeStyle(context)),
                            )),
                          ],
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                padding:
                                    APPSTYLE_ExtraSmallPaddingVertical.copyWith(
                                        left: APPSTYLE_SpaceSmall,
                                        right: APPSTYLE_SpaceSmall),
                                child: Text('${widget.mealItem.price} KD',
