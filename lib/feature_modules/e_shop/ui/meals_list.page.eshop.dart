              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    padding: APPSTYLE_MediumPaddingHorizontal.copyWith(top: APPSTYLE_SpaceSmall,bottom: APPSTYLE_SpaceSmall,),
                    child: Text(
                      'orders'.tr,
            ...
            child:  Container(
                ...
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible: !eshopController.isCategoriesFetching.value && eshopController.mealCategories.isNotEmpty,
                      child: Container(
                        height: 36,
                        width: screenwidth,
                        alignment: Alignment.center,
                        child: ListView(
                          ...
                          children: [
                            addHorizontalSpace(APPSTYLE_SpaceMedium),
                            for (var i = 0; i < eshopController.mealCategories.length; i++)
                              Container(
                                ...
                                child: MealCategoryCardComponentEshop(
                                    label:Localizations.localeOf(context)
                                        .languageCode
                                        .toString() ==
                                        'ar'?eshopController.mealCategories[i].arabicName:
                                    eshopController.mealCategories[i].name,
                                    isSelected: eshopController.currentMealCategoryId.value == eshopController.mealCategories[i].id,
                                    onClick: () {
                                      eshopController.getMealsByCategory(eshopController.mealCategories[i].id);
                                    }),
                              ),
                          ],
                        ),
                              ...
                              return MealItemCardComponent_Eshop(
                                ...
                                mealItem:
                                  ...
                                  onAdded: (int count){
                                    print("count");
                                    print(count);
                                    eshopController.updateCartItem( eshopController
                                        .meals[indx].id,count,count>0);
                                  });
