import 'package:dietdone/feature_modules/profile/constants/http_request_endpoints.constants.profile.dart';
...
class ProfileHttpService {
  ...
  Future<String> updateProfileData(UserData userData, String mobile) async {
    try {
      AppHttpResponse response = await patchRequest(
          ProfileHttpRequestEndpoint_Profile, userData.toJson());
  ...
  Future<bool> updateAllergies(
      List<GeneralItem> allergies, String mobile) async {
    try {
      AppHttpResponse response =
          await patchRequest(ProfileHttpRequestEndpoint_Allergy, {
        "mobile": mobile,
  ...
  Future<bool> updateDislikes(
      List<GeneralItem> allergies, String mobile) async {
    try {
      AppHttpResponse response =
          await patchRequest(ProfileHttpRequestEndpoint_Dislike, {
        "mobile": mobile,
