...
class PrePostIconButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onPressed,
      child: Container(
          padding: isRemoveVerticalPadding == null
              ? EdgeInsets.symmetric(vertical: APPSTYLE_SpaceSmall * 1.5)
              : null,
          decoration: BoxDecoration(
            border: border != ""
                ? Border(
                    bottom: BorderSide(
                        width: border!.contains('bottom') ? .15 : 0.0,
                        color: theme == 'light'
                            ? APPSTYLE_Grey20
                            : APPSTYLE_Grey40))
                : null,
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        ...
                        right: (Localizations.localeOf(context)
                            ...
                            ? 0
                            : APPSTYLE_SpaceMedium)),
                    child: Icon(preIconData,
                        color: specialColor == 1
                            ? APPSTYLE_GuideRed
                            : specialColor == 2
                  ...
                  child: Text(buttonTitle,
                      ...
                      style: getBodyMediumStyle(context).copyWith(
                          ...
                          fontWeight: theme == 'light'
                              ...
                              : FontWeight.normal))),
              Visibility(
                  visible: postIconData != null,
                  child: Icon(postIconData,
                      color: specialColor == 1
                          ? APPSTYLE_GuideRed
                          : specialColor == 2
                              ? APPSTYLE_PrimaryColor
