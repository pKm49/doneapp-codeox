...
import 'package:dietdone/shared_module/constants/available_genders.shared.constant.dart';
...
import 'package:dietdone/shared_module/ui/components/dob_picker.profile.component.dart';
import 'package:dietdone/shared_module/ui/components/photo_selector.component.shared.dart';
...
class EditProfilePage_Profile extends StatefulWidget {
  ...
  @override
  State<EditProfilePage_Profile> createState() =>
      _EditProfilePage_ProfileState();
}
              ...
              child: InkWell(
                onTap: () {
                  if (!profileController.isUserDataFetching.value &&
                    ...
                    sharedController
                        .changeMobile(profileController.userData.value.mobile);
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Visibility(
                            visible:
                                !profileController.isUserDataFetching.value,
                                ...
                                child: Shimmer.fromColors(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: profileController.gender.value ==
                                              VALID_GENDERS.female.name
                                          ? APPSTYLE_Black
                                          : APPSTYLE_Grey20,
                                    ),
                                  ),
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    profileController
                                        .changeGender(VALID_GENDERS.male.name);
                                  },
                                  child: Container(
                                    height: screenhight * 0.07,
                                    decoration: BoxDecoration(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    profileController.changeGender(
                                        VALID_GENDERS.female.name);
                                  },
                                  child: Container(
                                    height: screenhight * 0.07,
                              ...
                              child: Expanded(
                                  ...
                                  child: TextFormField(
                                      controller: profileController
                                          .firstNameEnglishTextEditingController
                                          .value,
                                      validator: (email) =>
                                          checkIfNameFormValid(
                                              email, 'first_name_en'),
                                      decoration:
                                          bottomBorderInputDecoration.copyWith(
                          ...
                          children: [
                            ...
                            Visibility(
                              ...
                              child: Expanded(
                                  ...
                                  child: TextFormField(
                                      controller: profileController
                                          .lastNameEnglishTextEditingController
                                          .value,
                                      validator: (email) =>
                                          checkIfNameFormValid(
                                              email, 'last_name_en'),
                          ...
                          children: [
                            ...
                            Visibility(
                              ...
                              child: Expanded(
                                  ...
                                  child: TextFormField(
                                      controller: profileController
                                          .firstNameArabicTextEditingController
                                          .value,
                                      validator: (email) =>
                                          checkIfArabicNameValid(
                                              email, 'first_name_ar', true),
                                      decoration:
                                          bottomBorderInputDecoration.copyWith(
                          ...
                          children: [
                            ...
                            Visibility(
                              ...
                              child: Expanded(
                                  ...
                                  child: TextFormField(
                                      controller: profileController
                                          .lastNameArabicTextEditingController
                                          .value,
                                      validator: (email) =>
                                          checkIfArabicNameValid(
                                              email, 'last_name_ar', true),
                                      decoration:
                                          bottomBorderInputDecoration.copyWith(
