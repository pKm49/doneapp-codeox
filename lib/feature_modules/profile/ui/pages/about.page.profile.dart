...
import 'package:dietdone/feature_modules/profile/ui/components/preposticon_button.component.shared.dart';
...
class _AboutPage_ProfileState extends State<AboutPage_Profile> {
        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: Text("diet_done_caption".tr,
            ...
            Padding(
              padding: APPSTYLE_LargePaddingHorizontal,
              child: Text("diet_done_description".tr,
              ...
              child: Row(
                children: [
                  InkWell(
                    ...
                    child: Container(
                      decoration:
                          APPSTYLE_BorderedContainerLargeDecoration.copyWith(
  ...
  void showDeleteAccountConfirmDialogue(BuildContext context) async {
    final dialogTitleWidget = Text('account_delete_title'.tr,
        style: getHeadlineMediumStyle(context).copyWith(
            color: APPSTYLE_Grey80, fontWeight: APPSTYLE_FontWeightBold));
    final dialogTextWidget =
        Text('account_delete_content'.tr, style: getBodyMediumStyle(context));
