...
class _MyAddressListPage_AddressState extends State<MyAddressListPage_Address> {
                ...
                child: Column(
                  children: [
                    Visibility(
                        ...
                        child: Padding(
                          padding:
                              APPSTYLE_MediumPaddingAll.copyWith(bottom: 0),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return AddressCardComponentShared(
                                ...
                                onEditSelected: () {
                                  addressController.changeAuditAddress(
                                      addressController
                                          .customerAddressList[index].id);
                                },
                                shippingAddress: addressController
                                    .customerAddressList[index],
                              );
                            }),
                      ),
                    ),
  ...
  void showDeleteConfirmDialogue(BuildContext context, int addressId) async {
    final dialogTitleWidget = Text('address_delete_title'.tr,
        style: getHeadlineMediumStyle(context).copyWith(
            color: APPSTYLE_Grey80, fontWeight: APPSTYLE_FontWeightBold));
    final dialogTextWidget = Text(
      'address_delete_content'.tr,
